...
public class PhoneBook {
	...
	public ArrayList<PhoneEntry> findEntryByNotFullName(String entryName) {
		...
		// Sort result by Name
		Collections.sort(result, PhoneNameComparator);
		return result;
	}
	...
	public void disp() {
		Collections.sort(phoneEntries, PhoneNameComparator);
	...
	private Comparator<PhoneEntry> PhoneNameComparator = new Comparator<PhoneEntry>() {

		public int compare(PhoneEntry s1, PhoneEntry s2) {
			String PhoneEntryName1 = s1.getName().toUpperCase();
			String PhoneEntryName2 = s2.getName().toUpperCase();

			// ascending order
			return PhoneEntryName1.compareTo(PhoneEntryName2);
