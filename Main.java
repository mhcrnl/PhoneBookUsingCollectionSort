		...
		while (check) {
			...
			try {
				...
				case 3: {
					...
					case 1:
						...
						if (phoneBookMng.editEntryByName(existedName, newName)) {
							...
							System.out
									.println("Modification is NOT successful");
						}
						break;
					case 2:
						input.nextLine();
						...
						System.out
								.println("Enter entry number u want to edit: ");
						String oldNumber = input.nextLine();
						System.out.println("Enter new entry number");
						String newNumber2 = input.nextLine();
						if (phoneBookMng.editEntryByNumber(entryName2,
								oldNumber, newNumber2)) {
							System.out.println("Modification is successful");
						} else {
							System.out
									.println("Modification is NOT successful");
				...
				case 5:
					...
					PhoneEntry entry2 = phoneBookMng
							.findEntryByName(entryName3);
					if ((entry2 != null)
				...
				case 6:
					System.out
							.println("Do u want to find by name or number : 1?2");
					int temp2 = input.nextInt();
					switch (temp2) {
					case 1:
						input.nextLine();
						System.out
								.println("Enter the name that u want to find :");
				...
				case 7:
					...
					if (phoneBookMng.movePhoneNumberToOtherEntry(
							entryNameTarget, entryNameSource, phoneNumber)) {
						System.out
								.println("Move the phone number successfully");
				...
				System.out.println("InputMistmatch!!!");
			}
